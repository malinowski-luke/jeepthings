    ...
    <div className='About'>
      <div className='about-container' id='about'>
        ...
        <p>
          ...
          around (sorry craigslist is for creeps and nigerian princes). The goal
          of this project was to build an app with the same functiality as
          craigslist but, with better css.
        </p>
      </div>
    </div>
  )
